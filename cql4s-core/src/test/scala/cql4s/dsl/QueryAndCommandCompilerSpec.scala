  ...
  "Select" - {
    ...
    "where" - {
      "id = ?" in {
        baseQuery
          .where(_("id") === :?)
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events WHERE id = ?"
      }
      ...
      "id = id" in {
        baseQuery
          .where(e => e("id") === e("id"))
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events WHERE id = id"
      }
      ...
      "id = ? and venue = ?" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events WHERE id = ? AND venue = ?"
      }
      ...
      "id = ? or venue = ?" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events WHERE id = ? OR venue = ?"
      }
      ...
      "id = ? or venue = ? and start_time = ?" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events WHERE id = ? OR venue = ? AND start_time = ?"
      }
    ...
    "group by" - {
      "1 field" in {
        baseQuery
          .groupBy(_("venue"))
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events GROUP BY venue"
      }
      ...
      "2 fields" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events GROUP BY venue, tickets"
      }
    }
    ...
    "order by" - {
      "one field (default)" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events ORDER BY start_time"
      }
      ...
      "one field (ascending)" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events ORDER BY start_time ASC"
      }
      ...
      "one field (descending)" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events ORDER BY start_time DESC"
      }
      ...
      "two fields" in {
        baseQuery
          ...
          .compile
          .cql shouldBe "SELECT (int)? FROM music.events ORDER BY start_time DESC, venue"
      }
    }
    ...
    "limit" in {
      baseQuery
        .limit(10L[bigint])
        .compile
        .cql shouldBe "SELECT (int)? FROM music.events LIMIT ?"
    }
    ...
    "per partition limit" in {
      baseQuery
        ...
        .compile
        .cql shouldBe "SELECT (int)? FROM music.events PER PARTITION LIMIT ?"
    }
  }
